...
public interface LibroRepository extends JpaRepository<Libro,Long> {
    ...
    @Query("SELECT new com.libreriasanjuan.apirestspringboot.dto.LibrosMasVendidosDTO(l.libroId,l.libroPrecio - 100," +
            " l.libroTitulo,l.libroAutor,l.libroPortada, SUM(cl.libroCantidad)) " +

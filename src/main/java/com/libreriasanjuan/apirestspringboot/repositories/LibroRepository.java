...
public interface LibroRepository extends JpaRepository<Libro,Long> {
    ...
    @Query("SELECT new com.libreriasanjuan.apirestspringboot.dto.LibrosMasVendidosDTO(l.libroId, l.libroPrecio, l.libroTitulo, l.libroAutor, l.libroPortada, SUM(cl.libroCantidad)) "
            + "FROM Libro l "
            + "JOIN CompraLibro cl ON l.libroId = cl.libro.libroId "
